...
| 이성찬 | 컴퓨터공학과 | 202211495 | DB 구현 | 유저 사이드 |
| 손혜원 | 컴퓨터공학과 | 202411388 | GUI 구현 | 유저 사이드 |
| 차태훈 | 컴퓨터공학과 | 202211536 | GUI 구현 | 어드민 사이드 |
| 조제현 | 컴퓨터공학과 | 202313039 |  DB 구현 | 어드민 사이드 |
| 김민아 | 응용통계학과 | 202311045 | Auth 구현 | 로그인 |
